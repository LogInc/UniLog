...
INSERT INTO course (	course_code,
	...
	VALUES	('CS101', 'spring', '2013', 'th', '2013-9-15', '2014-1-1', 'Digital Logic Design', 6, '', 'Digital Logic Design introduces you to the knowledge on which the structure of the modern digital world rests.'),
			('CS102', 'spring', '2014', 'th', '2014-9-15', '2015-1-1', 'Database and Management', 7, '', "It's all about database systems that are crucial is storing the behemoth of information that runs our world."),
			...
			('CS105', 'fall', '2015', 'th', '2015-1-3', null, 'Control Systems', 9, 'fixed_cs.jpg', 'Build the foundation to analysing the response of real world systems.'),
			('CS106', 'fall', '2015', 'th', '2015-1-3', null, 'Embedded Systems Design', 10, 'fixed_esd.jpg', 'Learn to solder.'),
			('CS107', 'fall', '2015', 'th', '2015-1-3', null, 'Web Technologies', 11, 'fixed_wt.jpg', 'Gain an insight in the web technologies that make the world wide web so accessible.');
END;
runQuery();
