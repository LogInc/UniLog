...
<div id="addcourseScreen"> 
	<form method='post' action='<?php echo base_url('course/add'); ?>'>
			...
			<div class="row">
				...
				<div class ="col-md-12 form-group form-group-lg form-inline" style="margin-left: auto;margin-right: auto">
					<div class="radio col-md-3">
						<label><input type="radio" name="course_term" value="fall"> <strong>Fall</strong></label>
					</div>
					<div class="radio col-md-4">
						<label><input type="radio" name="course_term" value="spring"><strong>Spring</strong></label>                    
					</div>
				</div>
				<div class ="col-md-12 form-group form-group-lg form-inline" style="margin-left: auto;margin-right: auto">
					<div class="radio col-md-3">
						<label><input type="radio" name="course_type" value="th"> <strong>Theory</strong></label>
					</div>
					<div class="radio col-md-4">
						<label><input type="radio" name="course_type" value="pr"><strong>Practical</strong></label>                    
					</div>
				</div>   
				<div class="col-md-12">
					<div style="margin-left: 12px;margin-right: 12px">
						<label for="course_description"></label>
						<textarea class="form-control" rows="6" id="input_post" name="course_description" placeholder="Write Course Description..."></textarea>
