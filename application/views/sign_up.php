...
<div class="col-md-5">
	...
	<div class="form-group form-group-lg">
		<div class="col-lg-offset-3 col-md-8 col-md-offset-4 col-sm-10 col-sm-offset-2">
			<button class="btn btn-primary btn-lg btn-block" type="submit" name="submit_signup">Sign Up</button>
		</div>
	</div>

	<div class="form-group form-group-lg">
		<div class="col-lg-offset-3 col-md-8 col-md-offset-4 col-sm-4 col-sm-offset-2">
