...
<html>
    <head>
        <title>UniLog | <?php echo $text; ?></title>
        <meta charset="utf-8">
    ...
    <body>
        <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-5" id="signIn_form" style="<?php if ($signup) {echo 'display:none';} ?>">
                ...
                <div class="col-md-5" id="signUp_form" style="<?php if (!$signup) {echo 'display:none';} ?>">
                    <form class="form-horizontal" role="form" method="post">
                        <h2>Sign Up</h2>
